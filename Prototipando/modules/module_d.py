...
module_d_blueprint = Blueprint('module_d', __name__,url_prefix='/module_d')

@module_d_blueprint.route('/')
def module_d():
    return render_template('module_d.html')

@module_d_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
