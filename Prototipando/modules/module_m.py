...
module_m_blueprint = Blueprint('module_m', __name__,url_prefix='/module_m')

@module_m_blueprint.route('/')
def module_m():
    return render_template('module_m.html')

@module_m_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
