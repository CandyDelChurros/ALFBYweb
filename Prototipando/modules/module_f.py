...
module_f_blueprint = Blueprint('module_f', __name__,url_prefix='/module_f')

@module_f_blueprint.route('/')
def module_f():
    return render_template('module_f.html')

@module_f_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
