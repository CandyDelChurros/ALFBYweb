...
module_h_blueprint = Blueprint('module_h', __name__,url_prefix='/module_h')

@module_h_blueprint.route('/')
def module_h():
    return render_template('module_h.html')

@module_h_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
