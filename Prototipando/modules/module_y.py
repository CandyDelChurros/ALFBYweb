...
module_y_blueprint = Blueprint('module_y', __name__,url_prefix='/module_y')

@module_y_blueprint.route('/')
def module_y():
    return render_template('module_y.html')

@module_y_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
