...
module_l_blueprint = Blueprint('module_l', __name__,url_prefix='/module_l')

@module_l_blueprint.route('/')
def module_l():
    return render_template('module_l.html')

@module_l_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
