...
module_r_blueprint = Blueprint('module_r', __name__,url_prefix='/module_r')

@module_r_blueprint.route('/')
def module_r():
    return render_template('module_r.html')

@module_r_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
