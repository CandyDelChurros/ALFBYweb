...
module_s_blueprint = Blueprint('module_s', __name__,url_prefix='/module_s')

@module_s_blueprint.route('/')
def module_s():
    return render_template('module_s.html')

@module_s_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
