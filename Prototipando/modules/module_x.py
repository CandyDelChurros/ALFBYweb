...
module_x_blueprint = Blueprint('module_x', __name__,url_prefix='/module_x')

@module_x_blueprint.route('/')
def module_x():
    return render_template('module_x.html')

@module_x_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
