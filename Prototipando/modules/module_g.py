...
module_g_blueprint = Blueprint('module_g', __name__,url_prefix='/module_g')

@module_g_blueprint.route('/')
def module_g():
    return render_template('module_g.html')

@module_g_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
