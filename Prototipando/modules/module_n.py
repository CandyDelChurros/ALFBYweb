...
module_n_blueprint = Blueprint('module_n', __name__,url_prefix='/module_n')

@module_n_blueprint.route('/')
def module_n():
    return render_template('module_n.html')

@module_n_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
