...
module_z_blueprint = Blueprint('module_z', __name__,url_prefix='/module_z')

@module_z_blueprint.route('/')
def module_z():
    return render_template('module_z.html')

@module_z_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
