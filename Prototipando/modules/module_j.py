...
module_j_blueprint = Blueprint('module_j', __name__,url_prefix='/module_j')

@module_j_blueprint.route('/')
def module_j():
    return render_template('module_j.html')

@module_j_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
