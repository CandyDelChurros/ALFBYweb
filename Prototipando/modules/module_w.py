...
module_w_blueprint = Blueprint('module_w', __name__,url_prefix='/module_w')

@module_w_blueprint.route('/')
def module_w():
    return render_template('module_w.html')

@module_w_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
