...
module_v_blueprint = Blueprint('module_v', __name__,url_prefix='/module_v')

@module_v_blueprint.route('/')
def module_v():
    return render_template('module_v.html')

@module_v_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
