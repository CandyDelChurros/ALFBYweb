...
module_k_blueprint = Blueprint('module_k', __name__,url_prefix='/module_k')

@module_k_blueprint.route('/')
def module_k():
    return render_template('module_k.html')

@module_k_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
