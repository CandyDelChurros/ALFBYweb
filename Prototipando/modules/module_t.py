...
module_t_blueprint = Blueprint('module_t', __name__,url_prefix='/module_t')

@module_t_blueprint.route('/')
def module_t():
    return render_template('module_t.html')

@module_t_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
