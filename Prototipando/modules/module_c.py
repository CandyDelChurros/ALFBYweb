...
module_c_blueprint = Blueprint('module_c', __name__,url_prefix='/module_c')

@module_c_blueprint.route('/')
def module_c():
    return render_template('module_c.html')

@module_c_blueprint.route('/upload_image', methods=['POST'])
def upload_image():
    try:
